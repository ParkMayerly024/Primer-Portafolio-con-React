    ...
    <div className="pt-[8rem] pb-[4rem] bg-[#02050a]">
      ...
      <div className="w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between">
        <div className="text-[16px] mb-[2rem] md:mb-0 text-white opacity-20">
            MayWeb 2023 | All Rights Reserved
        </div>
        <div className="flex items-center space-x-10"> 
            <p className="text-[16px] text-white opacity-20">Terminos & Condiciones</p>
            <p className="text-[16px] text-white opacity-20">Politicas de Privacidad</p>
